  ...
  return (
    <nav className='w-100 h-24 bg-pink-100  shadow-lg'>
      <ul className='flex justify-between items-center h-full space-x-1'>
        ...
        <button className='w-32 h-16 bg-pink-900 bg-opacity-80 shadow-lg hover:bg-opacity-70 font-bold text-2xl rounded flex items-center justify-center' onClick={handleLogout}><Link href="" ><Users className='text-purple-200'></Users></Link></button>
        <button className='w-32 h-16 bg-pink-900 bg-opacity-80 shadow-lg hover:bg-opacity-70 font-bold text-2xl rounded flex items-center justify-center'><Link href="/"><LogOut className='text-purple-200'></LogOut></Link></button>
      </ul>
    </nav>
  );
}
